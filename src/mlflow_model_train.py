...
def train_model_mlflow(config_file):
    ...
    if train == True:
        ...
        rescale = 1./255  # Standard rescaling for image normalization
        ...
        mlflow_config=config['m1flow_config']
        ...
        with mlflow.start_run():
            ...
            if tracking_url_type_store != "file":
                mlflow.keras.log_model(model, "models", registered_model_name="VGG16")
            else:
